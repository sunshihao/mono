...
/** XADD 后 PUBLISH 的通知频道（订阅者：缓存失效、实时推送等） */
export const INGESTION_NOTIFICATION_CHANNEL =
    "ingestion:notifications" as const;
...
export type IngestionEventEnvelope = z.infer<
    typeof IngestionEventEnvelopeSchema
>;
